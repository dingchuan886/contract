  ...
  <body>
	 ...
	 <div class="span10">
	 	<ul class="nav nav-tabs">
	 		<!-- to mycontract -->
	 		   <button class="btn btn-info btn-fr" type="button" onclick="javascript:window.location.href='${contract_ct_url}contract/ctContract/toAddCtContract'">添加新合同</button>
            ...
            <li class=""><a href="javascript:void(0)" onclick="javascript:window.location.href='${contract_ct_url}contract/myContract/showZhContract'" data-toggle="tab">众智315广告合同</a></li>
            <li class="active"><a href="javascript:void(0)" onclick="javascript:window.location.href='${contract_ct_url}contract/myContract/showCtContract'" data-toggle="tab">车团合同</a></li>
          </ul>
        
          <form action="/contract/myContract/showCtContract" class="form-horizontal" id="form1">
           <div class="row-fluid">
            ...
            <table class="table table-bordered">
              ...
              <#list myCtContract.list as ct>
                <tr <#if ct_index%2==0>style="background-color:#FDD8C6"<#else>style="background-color:#CBE4E8"</#if>>
                  ...
                  <td>${ct.conCt.con_total_price}</td>
                 ...
                 <#if (ct.conRebates?size>0)>
                  ...
                  <a href="javascript:void(0)" onclick="viewCon(this)">提交</a>
