  ...
  <body>
	 ...
	 <div class="span10">
	 	<ul class="nav nav-tabs">
	 		<!-- to mycontract -->
	 		 <button class="btn btn-info btn-fr" type="button" onclick="javascript:window.location.href='${contract_ct_url}contract/czContract/toAddCzContract'">添加新合同</button>
            <li class="active"><a href="javascript:void(0)" onclick="javascript:window.location.href='${contract_ct_url}contract/myContract/showCzContract'" data-toggle="tab">众智车展合同</a></li>
          ...
          <form action="/contract/myContract/showCzContract" class="form-horizontal" id="form1">
            <div class="row-fluid">
