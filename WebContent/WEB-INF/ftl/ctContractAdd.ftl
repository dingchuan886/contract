...
<@c.left act=0/>
        ...
        <div class="span10">
          <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#" onclick="javascript:window.location.href='${contract_ct_url}contract/ctContract/toAddCtContract'" data-toggle="tab">车团合同</a></li>
          </ul>
          <form action="/contract/ctContract/ctContractPreview" class="form-horizontal" target="_blank" id="form1" method="post">
            <div class="row-fluid">
            ...
            <div class="row-fluid">
              ...
              <div class="control-group span5">
                ...
                <div class="controls">
                 <input type="text" name="media" value="车团"/>
                </div>
              </div>
            </div>
            <div class="row-fluid">
              ...
              <ul class="inline">
                ...
                <li>
                  <label class="radio">
                    <input type="radio" name="bus_type" style="margin:0" value="1" checked="checked">
                    团购
                  </label>
                </li>
                <li>
                  <label class="radio">
                    <input type="radio" name="bus_type" style="margin:0" value="2">
                    特卖惠
                  </label>
                </li>
              </ul>
            ...
            <div class="row-fluid">
              <div class="control-group span5">
                ...
                <div class="controls">
                  <input class="input-small" type="text" name="act_addr" id="act_addr" style="width:205px;"/>
                </div>
              </div>
              <div class="control-group span6">
                ...
                <div class="controls">
                  <div class="input-append date form_datetime">
                      <input type="text" value="" readonly="true" name="act_date" data-date="2013-02-21" style="width:180px;" id="act_date">
            ...
            <div class="row-fluid">
              <div class="control-group span5">
                ...
                <div class="controls">
                  <input class="input-small" type="text" name="total_price" id="total_price" style="float:left"/>
                </div>
            ...
            <ul class="inline">
              ...
              <li>
                <label class="radio">
                  <input type="radio" name="stamp" value="1" style="margin:0">
                  客户先盖章
                </label>
              </li>
              <li>
                <label class="radio">
                  <input type="radio" name="stamp" value="2" style="margin:0">
                  公司先盖章
                </label>
              </li>
            </ul>
