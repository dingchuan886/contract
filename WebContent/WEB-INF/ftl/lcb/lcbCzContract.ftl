  ...
  <body>
	 ...
	 <div class="span10">
	 	<ul class="nav nav-tabs">
	 		<!-- to mycontract -->
            <li class="active"><a href="javascript:void(0)" onclick="javascript:window.location.href='${contract_ct_url}contract/flowViewContract/showCzContract'" data-toggle="tab">众智车展合同</a></li>
          ...
          <form action="/contract/flowViewContract/showCzContract" class="form-horizontal" id="form1">
            <div class="row-fluid">
            ...
            <div class="row-fluid">
              ...
              <div class="control-group span5">
               ...
               <div><button onclick="doSubmit('/contract/flowViewContract/showCzContract')">查询</button>
               <button onclick="doSubmit('/contract/downloadAttach/downloadFlowCzExcell')">下载数据</button></div>
            </div>
...
function delCon(obj){
	...
	var id = $(obj).parent().siblings("td").eq(1).html();
	var pageNum = ${myCzContract.pageNum};
	if(flag){
