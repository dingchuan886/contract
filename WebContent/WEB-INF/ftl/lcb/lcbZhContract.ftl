  ...
  <body>
	 ...
	 <div class="span10">
	 	<ul class="nav nav-tabs">
            ...
            <li class="active"><a href="javascript:void(0)" onclick="javascript:window.location.href='${contract_ct_url}contract/flowViewContract/showZhContract'" data-toggle="tab">众智315广告合同</a></li>
            <li class=""><a href="javascript:void(0)" onclick="javascript:window.location.href='${contract_ct_url}contract/flowViewContract/showCtContract'" data-toggle="tab">车团合同</a></li>
          </ul>
          <form action="/contract/flowViewContract/showZhContract" class="form-horizontal" id="form1">
            <div class="row-fluid">
            ...
            <div class="row-fluid">
              ...
              <div class="control-group span5">
               ...
               <div><button onclick="doSubmit('/contract/flowViewContract/showZhContract')">查询</button>
               <button onclick="doSubmit('/contract/downloadAttach/downloadFlowZhExcell')">下载数据</button></div>
            </div>
