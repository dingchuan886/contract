  ...
  <div class="well">
    <form action="#">
      <div class="v-h" style="text-align:left">
      	...
      	<input name="" type="button" data-toggle="modal" href="#myModal" value="提交" onclick="edit.disabled='false';"/></div>
      	-->
      <div class="m2">
        <h2>上海众智电子商务有限公司</h2>
        <h3>业务返利申请单</h3>
        <div class="m3">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb7">
            <tbody>
              ...
              <tr>
                <td>客户名称：${map.conZh.cus_name}</td>
                <td>销售合同号/销售订单号：${map.conZh.con_zh_id}</td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="2">
                  <div class="m-sqd">
                    <ul>
                      <li><span>合同总金额：</span><p>${map.conZh.con_total_price}</p></li>
