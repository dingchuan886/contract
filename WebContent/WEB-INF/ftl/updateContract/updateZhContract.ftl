	...
	<@c.left/>
        <div class="span10">
          ...
          <!--  <li class=""><a href="#" onclick="javascript:window.location.href='${contract_ct_url}contract/czContract/toAddCzContract'" data-toggle="tab">众智车展合同</a></li> -->
            <li class="active"><a href="#" data-toggle="tab">众智315广告合同</a></li>
          ...
          <form action="/contract/zhContract/updateZhContract" class="form-horizontal" method="post" id="form1"  target="_blank">
            <div class="row-fluid">
              ...
              <div class="control-group span5">
                ...
                <div class="controls">
                   <select name="cus_type">
                    <option value="1" <#if zhContract.cus_type==1>selected</#if>>大客户</option>
                    <option value="2" <#if zhContract.cus_type==2>selected</#if>>区域</option>
                    <option value="3" <#if zhContract.cus_type==3>selected</#if>>经销商</option>
                  </select>
                </div>
              </div>
              <div class="control-group span5">
                ...
                <div class="controls">
                  <input type="text" name="cus_name" id="cus_name" value="${zhContract.cus_name}"/>
                  <input type="hidden" name="con_zh_id" value="${zhContract.con_zh_id}"/>
                </div>
              </div>
            </div>
     <div class="row-fluid">
            ...
            <ul class="inline span5">
              ...
              <li>
                <label class="radio">
                  <input type="radio" name="material" style="margin:0" value="0" <#if zhContract.material==0>checked="checked"</#if>>
                  无
                </label>
              </li>
              <li>
                <label class="radio">
                  <input type="radio" name="material" style="margin:0" value="1" <#if zhContract.material==1>checked="checked"</#if>>
                  有
                </label>
              </li>
          ...
          <div class="control-group span5">
                ...
                <div class="controls">
                  <select name="con_type">
                    <option value="0" <#if zhContract.con_type==0>selected</#if>>会员</option>
                    <option value="1" <#if zhContract.con_type==1>selected</#if>>硬广</option>
                    <option value="2" <#if zhContract.con_type==2>selected</#if>>会员兼硬广</option>
                    <option value="3" <#if zhContract.con_type==3>selected</#if>>广告+活动</option>
                  </select>
                </div>
              </div>
            ...
            <div class="row-fluid" style="border-bottom:1px solid #ddd">
              <div class="control-group span5">
                ...
                <div class="controls">
                  <input type="text" name="cus_addr" value="${zhContract.cus_addr}">
                </div>
              </div>
              <div class="control-group span5">
                <label for="type" class="control-label">电话</label>
                <div class="controls">
                  <input type="text" name="cus_tel" id="cus_tel" value="${zhContract.cus_tel}"><br/>
                  <input type="hidden" id="con_type" name="con_state" value="${zhContract.con_state}">
                  <input type="hidden" name="con_id" value="${zhContract.con_zh_id}">
            ...
            <div class="row-fluid" style=" padding-top:20px">
              <div class="control-group span5">
                ...
                <div class="controls">
                  <input class="input-small" type="text" name="con_total_price" style="float:left" id="con_total_price" value="${zhContract.con_total_price}">
                </div>
            ...
            <ul class="inline">
              ...
              <li>
                <label class="radio">
                  <input type="radio" style="margin:0" name="stamp" value="1" <#if zhContract.stamp==1>checked="checked"</#if>>
                  客户先盖章
                </label>
              </li>
              <li>
                <label class="radio">
                  <input type="radio" style="margin:0" name="stamp" value="2" <#if zhContract.stamp==2>checked="checked"</#if>>
                  公司先盖章
                </label>
              </li>
            </ul>
