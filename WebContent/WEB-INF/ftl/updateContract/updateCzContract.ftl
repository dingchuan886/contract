...
<div class="span10">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#" data-toggle="tab">众智车展合同</a></li>
          ...
          <form action="/contract/czContract/updateCzContract" class="form-horizontal" method="post" id="form1"  target="_blank">
            <div class="row-fluid">
              ...
              <div class="control-group span5">
                ...
                <div class="controls">
                  <select name="cus_type" id="">
                    <option value="1" <#if czContract.cus_type==1>selected</#if>>大客户</option>
                    <option value="2" <#if czContract.cus_type==2>selected</#if>>区域</option>
                    <option value="3" <#if czContract.cus_type==3>selected</#if>>经销商</option>
                  </select>
                </div>
              </div>
              <div class="control-group span5">
                ...
                <div class="controls">
                  <input type="text" name="cus_name" id="cus_name" value="${czContract.cus_name}">
                  <input type="hidden" name="con_cz_id" value="${czContract.con_cz_id}">
                </div>
              </div>
            </div>
            <ul class="inline">
              ...
              <li>
                <label class="radio">
                  <input type="radio" name="con_type" style="margin:0" value="0" <#if czContract.con_type==0>checked="checked"</#if>>
                  车展
                </label>
              </li>
              <li>
                <label class="radio">
                  <input type="radio" name="con_type" style="margin:0" value="1" <#if czContract.con_type==1>checked="checked"</#if>>
                  车展+广告
                </label>
              </li>
              <li>
                <label class="radio">
                  <input type="radio" name="con_type" style="margin:0" value="2" <#if czContract.con_type==2>checked="checked"</#if>>
                  车展+活动
                </label>
              </li>
            </ul>
            <div class="row-fluid" style="border-bottom:1px solid #ddd">
              <div class="control-group span5">
                ...
                <div class="controls">
                  <input type="text" name="cus_addr" value="${czContract.cus_addr}"/>
                </div>
              </div>
              <div class="control-group span5">
                <label for="type" class="control-label">电话</label>
                <div class="controls">
                  <input type="text" name="cus_tel" id="cus_tel" value="${czContract.cus_tel}">
                </div>
              </div>
            </div>
            ...
            <div class="row-fluid">
              <div class="control-group span5">
                ...
                <div class="controls">
                  <input class="input-small" type="text" name="cus_count" id="cus_count" value="${czContract.cus_count}">
                </div>
              </div>
              <div class="control-group span6">
                <label for="contractEnd" class="control-label">活动日期</label>
               <div class="controls">
                  <input name="act_date" value="${czContract.act_date}">
                </div>
              </div>
            </div>
            <div class="row-fluid">
              <div class="control-group span5">
                ...
                <div class="controls">
                  <input type="text" id="act_addr" name="act_addr" value="${czContract.act_addr}">
                  <input type="hidden" id="con_state" name="con_state" value="${czContract.con_state}">
                  <input type="hidden" name="con_id" value="${czContract.con_cz_id}">
                </div>
              </div>
              <div class="control-group span5">
                <label for="type" class="control-label">合计执行总价</label>
                <div class="controls">
                  <input class="input-small" type="text" name="con_total_price" id="con_total_price" style="float:left" value="${czContract.con_total_price}">
                </div>
                <label style="float:left; padding:5px 0 0 5px;">元</label>
              </div>
            </div>
            <#-- 添加广告！！-->
             <div id="advertis" class="bs-docs-example" 
             <#if czContract.con_type==1>
             style="width:100%; overflow-x:scroll;white-space:nowrap;"
             <#else>
             style="width:100%; overflow-x:scroll;white-space:nowrap;display:none;"
             </#if>
             >
              ...
              <input type="button" value="添加行" onclick="add()"/>
                ...
                <tbody id="tbody">
                <#if czContract.tbConZhSubs?size gt 0>
                  <#list czContract.tbConZhSubs as subs>
                  <tr class="nowtr">
                    <td>
                    <div class="btn-group">
                      <select class="btn dropdown-toggle" name="tbConZhSubs.media" style="width:130px">
                      	<option value="1" <#if subs.media==1>selected="selected"</#if>>315che.com</option>
                      	<option value="2" <#if subs.media==2>selected="selected"</#if>>框架</option>
                      	<option value="3" <#if subs.media==3>selected="selected"</#if>>其他</option>
                      </select>
                    </div>
                    </td>
                    <td><input type="text" name="tbConZhSubs.position" value="${subs.position}" style="width:100px"/></td>
                    <td><input type="text" name="tbConZhSubs.standard" value="${subs.standard}" style="width:80px"/></td>
                    <td><input type="text" name="tbConZhSubs.brand" value="${subs.brand}" style="width:80px"/></td>
                    <td>
                      <!-- <input type="text" value="" readonly="" data-date="2013-02-21" style="width:100px;"> -->
                      <input type="text" name="tbConZhSubs.put_date" value="${subs.put_date}" style="width:100px;" size="10">
                    </td>
                    <td><input type="text" name="tbConZhSubs.copyright" value="${subs.copyright}" style="width:100px"/></td>
                    <td><input type="text" name="tbConZhSubs.unit_price" value="${subs.unit_price}" style="width:100px"/></td>
                    <td><input type="text" name="tbConZhSubs.content" value="${subs.content}" unit_pricestyle="width:100px"/></td>
            ...
            <div class="row-fluid"  style="margin-top:20px">
              <div class="control-group span5">
                ...
                <div class="controls"><textarea name="con_content" rows="5" style=" width:555px; float:left">${czContract.con_content}</textarea></div>
              </div>
            </div>
            <ul class="inline">
              ...
              <li>
                <label class="radio">
                  <input type="radio" name="stamp" style="margin:0" value="1" <#if czContract.stamp==1>checked="checked"</#if>/>
                  客户先盖章
                </label>
              </li>
              <li>
                <label class="radio">
                  <input type="radio" name="stamp" style="margin:0" value="2" <#if czContract.stamp==2>checked="checked"</#if>/>
                  公司先盖章
                </label>
              </li>
            </ul>
...
function subAccount(){
	...
	var phone = $("#phone").val();
	var phonereg = /^1[3,4,5,7,8][0-9]{9}$/;
	var accType = "${conAccount.acc_state}";
	var isBack = $("#isback").prop("checked");
