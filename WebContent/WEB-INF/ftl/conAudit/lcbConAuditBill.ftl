...
<body>
	...
	<div class="span10">
        ...
        <div class="bs-docs-example" style="width:100%; overflow-x:scroll;white-space:nowrap;">
        	<ul class="nav nav-tabs">
	            <li class="<#if conType=='SHCZ'>active</#if>"><a href="#" onclick="javascript:window.location.href='${contract_ct_url}contract/tbConFlowAudit/flowConAuditBill?conType=SHCZ'" data-toggle="tab">众智车展合同</a></li>
	            <li class="<#if conType=='SHZH'>active</#if>"><a href="#" onclick="javascript:window.location.href='${contract_ct_url}contract/tbConFlowAudit/flowConAuditBill?conType=SHZH'" data-toggle="tab">众智315广告合同</a></li>
	            <li class="<#if conType=='SHCT'>active</#if>"><a href="#" onclick="javascript:window.location.href='${contract_ct_url}contract/tbConFlowAudit/flowConAuditBill?conType=SHCT'" data-toggle="tab">车团合同</a></li>
          	</ul>
	              			...
	              			<#list pager.list as conFlowCon>
		              			...
		              			<tr>
		              				...
		              				<a href="${contract_ct_url}contract/myContract/viewCtContract?conId=${conFlowCon.conCt.con_ct_id}" target="_blank">查看</a>&nbsp
		              					<a href="#" data-toggle="modal" onclick="flowAudit('${conType}', ${conFlowCon.conFlow.con_flow_id});">审核通过</a>&nbsp
	...
	<div id="rejectModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
      	<div class="modal-footer" style="text-align:center; margin-top:10px">
      		<form id="rejectForm" action="${contract_ct_url}contract/tbConFlowAudit/rejectedFlow" method="post">
    ...
    <div id="auditModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    	<div class="modal-footer" style="text-align:center; margin-top:10px">
    		<form id="auditForm" action="${contract_ct_url}contract/tbConFlowAudit/flowCheck" method="POST" enctype="multipart/form-data">
    			<input type="hidden" name="conType" vlaue=""/>
      			<input type="hidden" name="conFlowId" vlaue=""/>
      			<label for="type" class="control-label">合同文件上传</label>
      			合同编号: <input type="type" name="conId" disabled vlaue=""/><br/><br/>
      			选取文件: <input type="file" name="conFile"/><br/><br/> 
	...
	<script type="text/javascript">
    	function flowAudit(conType, conFlowId){
      		if(confirm("确定通过该合同么?")){
      			window.location.href = "${contract_ct_url}contract/tbConFlowAudit/flowCheck?conType="+conType+"&conFlowId="+conFlowId;
      		}
      	}
