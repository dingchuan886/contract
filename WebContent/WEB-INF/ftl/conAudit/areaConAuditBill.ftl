...
<body>
	...
	<div class="span10">
        ...
        <div class="bs-docs-example" style="width:100%; overflow-x:scroll;white-space:nowrap;">
			<ul class="nav nav-tabs">
	            <li class="<#if conType=='SHCZ'>active</#if>"><a href="#" onclick="javascript:window.location.href='${contract_ct_url}contract/tbConFlowAudit/areaConAuditBill?conType=SHCZ'" data-toggle="tab">众智车展合同</a></li>
	            <li class="<#if conType=='SHZH'>active</#if>"><a href="#" onclick="javascript:window.location.href='${contract_ct_url}contract/tbConFlowAudit/areaConAuditBill?conType=SHZH'" data-toggle="tab">众智315广告合同</a></li>
	            <li class="<#if conType=='SHCT'>active</#if>"><a href="#" onclick="javascript:window.location.href='${contract_ct_url}contract/tbConFlowAudit/areaConAuditBill?conType=SHCT'" data-toggle="tab">车团合同</a></li>
          	</ul>
          	<div class="span10">
          	<form action="${contract_ct_url}contract/tbConFlowAudit/areaConAuditBill?conType=${conType}" class="form-horizontal" method="post" id="form1">
	          	<div class="row-fluid">
		             ...
		             <input type="hidden" name="pageNum" value="1">
		              <div><button type="button" onclick="document.forms[0].submit()">查询</button></div> 
	             </div>
	              			...
	              			<#list pager.list as conFlowCon>
		              			...
		              			<tr>
		              				...
		              				<a href="${contract_ct_url}contract/myContract/viewCtContract?conId=${conFlowCon.conCt.con_ct_id}" target="_blank">查看</a>
										<a href="javascript:areaAudit('${conType}', ${conFlowCon.conFlow.con_flow_id})">审核通过</a>
              			...
              			<#if conType=='SHCZ'>
	              			...
	              			<tr>
	              				...
	              				<td>
	              					...
	              					<a href="javascript:areaAudit('${conType}', ${conFlowCon.conFlow.con_flow_id})">审核通过</a>&nbsp 
	...
	<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
      <div class="modal-footer" style="text-align:center; margin-top:10px">
      	<form id="rejectForm" action="${contract_ct_url}contract/tbConFlowAudit/rejectedArea" method="post">
	...
	<script type="text/javascript">
    	...
    	function areaAudit(conType, conFlowId){
      		if(confirm("确定审核通过该合同么?")){
      			window.location.href = "${contract_ct_url}contract/tbConFlowAudit/areaCheck?conType="+conType+"&conFlowId="+conFlowId;
      		}
      	}
		...
		function changePage(pageNum){
			...
			$("#form1").submit();
			//location.href = "${contract_ct_url}contract/tbConFlowAudit/areaConAuditBill?pageNum=" + pageNum + "&conType=${conType}";
		}
