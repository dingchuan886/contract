...
<@c.left act=54/>
        ...
        <div class="span10">
          <ul class="breadcrumb">
           ...
           <form action="/contract/adveritesment/showAllAheadAdv" class="form-horizontal" id="form1">
            <div class="row-fluid">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
               ...
               <#list pageResult.list as map>
                <tr>
                  <td>
                  	<#if map.adv.adv_state==1>等待审核
                  	<#elseif map.adv.adv_state==2>经理审核通过
                  	<#elseif map.adv.adv_state==3>流程部审核通过
                  	<#elseif map.adv.adv_state==4>已驳回</#if>
                  </td>
                  <td>${map.orgName}</td>
                  ...
                  <#if map.adv.year!="">
                   ...
                   <td> <#if map.adv.adv_state==4><a href="javascript:void(0)" onclick="showReject(this,'${map.adv.adv_id}')">驳回详情</a></#if>
