...
<@c.left act=52/>
        ...
        <div class="span10">
          <ul class="breadcrumb">
            ...
            <li class="active">流程部审核合同提前申请</li>
          </ul>
    ...
    <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
      <div class="modal-footer" style="text-align:center; margin-top:10px">
      	<form id="rejectForm" action="${contract_ct_url}contract/adveritesment/flowRejectAdv" method="post">
      		<label for="type" class="control-label">审核驳回</label>
      		        <input type="hidden" name="advId"/><br/><br/>   
  ...
  function managerAudit(advId){
      		if(confirm("确定通过该合同么?")){
      			window.location.href = "${contract_ct_url}contract/adveritesment/flowAuditAdv?advId="+advId;
      		}
      	}
