      ...
      <div class="m2">
        ...
        <div class="m3">
          <table width="100%" border="1" cellspacing="0" cellpadding="0" class="tb7">
            <tbody>
              <tr>
                <td colspan="2">客户名称：${tbConcz.cus_name}</td>
                <td colspan="3">销售合同号/销售订单号：${tbConcz.con_cz_id}</td>
              </tr>
              <tr>
                <td colspan="2">合同总价：${tbConcz.con_total_price}&nbsp;元</td>
                <td colspan="2">已开票金额：${tbConcz.al_bill}&nbsp;元</td>
                 <input type="hidden" name="al_bill" value="${tbConcz.al_bill}">
