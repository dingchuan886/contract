            ...
            <tbody>
              ...
              <input type="hidden" name="con_id" value="${conZh.con_zh_id}"/>
               <input type="hidden" name="cus_name" value="${conZh.cus_name}"/>
                <td colspan="2">客户名称：${conZh.cus_name}</td>
                <td colspan="3">销售合同号/销售订单号：${conZh.con_zh_id}</td>
              </tr>
              <tr>
                <td colspan="2">合同总价：${conZh.con_total_price}&nbsp;元</td>
                <td colspan="2">已开票金额：${conZh.al_bill}&nbsp;元</td>
                <input type="hidden" name="al_bill" value="${conZh.al_bill}">
