...
<@c.left act=10/>
               ...
               <#list pager.list as map>
                <tr>
                  ...
                  <td>
                   ...
                   <td><a href="javascript:managerAudit('managerCheck',  ${map.conBill.bill_id})">审核通过</a>
  ...
  <script>
    function changePage(pageNum){
			...
			location.href = "${contract_ct_url}contract/tbConBill/toCheckBill?type=managerCheck&pageNum="+pageNum;
		}
