            ...
            <tbody>
              ...
              <input type="hidden" name="con_id" value="${conCz.con_cz_id}"/>
               <input type="hidden" name="cus_name" value="${conCz.cus_name}"/>
                <td colspan="2">客户名称：${conCz.cus_name}</td>
                <td colspan="3">销售合同号/销售订单号：${conCz.con_cz_id}</td>
              </tr>
              <tr>
                <td colspan="2">合同总价：${conCz.con_total_price}&nbsp;元</td>
                <td colspan="2">已开票金额：${conCz.al_bill}&nbsp;元</td>
                 <input type="hidden" name="al_bill" value="${conCz.al_bill}">
              ...
              <tr>
                <td>发票类型</td>
                <td><label class="radio"><input type="radio" name="bill_type" value="0">广告费</label></td>
