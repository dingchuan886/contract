...
<@c.left act=9/>
              ...
              <tbody>
               ...
               <#list pager.list as map>
                <tr>
                  ...
                  <td>
                    <#if (map.conBill.con_id)?starts_with('SHCZ')>
                   ${map.conCz.total_price}
                   <#elseif (map.conBill.con_id)?starts_with('SHZH')>
                     ${map.conZh.total_price}
                   <#elseif (map.conBill.con_id)?starts_with('SHCT') >
                     ${map.conCt.total_price}
                   </#if>
                  </td>
  ...
  <@c.js/>
    ...
    <script>
			...
			location.href = "${contract_ct_url}contract/tbConBill/lcbViewRejectBills?pageNum="+pageNum;
		}
