...
<html>
  ...
  <div class="well">
    ...
    <ul  class="nav nav-tabs"><li><a href="#" onclick="javascript:window.open('${contract_ct_url}contract/conAccount/viewAccount?conId=${zhContract.con_zh_id}')" data-toggle="tab">查看相关说明</a></li></li></ul>
    </div>
    <div class="logo">
      <ul>
