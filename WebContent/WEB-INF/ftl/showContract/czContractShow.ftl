...
<html>
  ...
  <div class="well">
    ...
    <input name="" type="button" data-toggle="modal" href="javascript:void(0)" value="提交" onclick="subContract()"/>
    <ul  class="nav nav-tabs"><li><a href="#" onclick="javascript:window.open('${contract_ct_url}contract/conAccount/viewAccount?conId=${czContract.con_cz_id}')" data-toggle="tab">查看相关说明</a></li></li></ul>
    </div>
    <div class="logo">
      <ul>
