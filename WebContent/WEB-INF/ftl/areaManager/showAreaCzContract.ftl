  ...
  <body>
	 ...
	 <div class="span10">
	 	<ul class="nav nav-tabs">
	 		<!-- to mycontract -->
            <li class="active"><a href="javascript:void(0)" onclick="javascript:window.location.href='${contract_ct_url}contract/areaManager/showCzareaManager'" data-toggle="tab">众智车展合同</a></li>
          ...
          <form action="/contract/areaManager/showCzareaManager" class="form-horizontal" id="form1">
            <div class="row-fluid">
            ...
            <div class="row-fluid">
              ...
              <div class="control-group span5">
               ...
               <div><button onclick="doSubmit('/contract/areaManager/showCzareaManager')">查询</button>
