  ...
  <body>
	 ...
	 <div class="span10">
	 	<ul class="nav nav-tabs">
	 		<!-- to mycontract -->
            <li class=""><a href="javascript:void(0)" onclick="javascript:window.location.href='${contract_ct_url}contract/deptManager/showCzDeptManager'" data-toggle="tab">众智车展合同</a></li>
            ...
            <li class="active"><a href="javascript:void(0)" onclick="javascript:window.location.href='${contract_ct_url}contract/deptManager/showCtDeptManager'" data-toggle="tab">车团合同</a></li>
          </ul>
          <form action="/contract/deptManager/showCtDeptManager" class="form-horizontal" id="form1">
            <div class="row-fluid">
            ...
            <div class="row-fluid">
              <div class="control-group span5">
               ...
               <div><button onclick="doSubmit('/contract/deptManager/showCtDeptManager')">查询</button>
...
$(document).ready(function(){
  ...
  /*var totalbill = 0;
	...
	<#list deptCtContract.list as ct>
		<#if ct.conCt.con_state != 5>
			conTotal[${ct_index}] = ${ct.conCt.con_total_price};
		</#if>
	</#list>
