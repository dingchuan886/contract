  ...
  <body>
	 ...
	 <div class="span10">
	 	<ul class="nav nav-tabs">
            ...
            <li class="active"><a href="javascript:void(0)" onclick="javascript:window.location.href='${contract_ct_url}contract/deptManager/showZhDeptManager'" data-toggle="tab">众智315广告合同</a></li>
          ...
          <form action="/contract/deptManager/showZhDeptManager" class="form-horizontal" id="form1">
            <div class="row-fluid">
            ...
            <div class="row-fluid">
              <div class="control-group span5">
               ...
               <div><button onclick="doSubmit('/contract/deptManager/showZhDeptManager')">查询</button>
