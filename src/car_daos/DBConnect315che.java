...
public class DBConnect315che {
	// static Logger logger = Logger.getLogger(DBConnect.class.getName());

	private DBConnectionManager315Che dcm;
	...
	void init() {
		dcm = DBConnectionManager315Che.getInstance();
		conn = dcm.getConnection();
	}

	public DBConnect315che() throws Exception {

		init();
	}

	public DBConnect315che(int is_tx) throws Exception {
		isTX = is_tx;
		init();
	}
	 ...
	 *            SQL���
	 */
	public DBConnect315che(String sql) throws Exception {
		init();
