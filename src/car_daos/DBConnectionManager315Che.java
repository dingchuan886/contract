...
public class DBConnectionManager315Che {
	private static final DBConnectionManager315Che instance = new DBConnectionManager315Che();

	private static String driverClass, jdbcUrl, user, password,proxoolDatasoucrce;
...
//		init();
	...
	public static DBConnectionManager315Che getInstance() {
		return instance;
	}

	private DBConnectionManager315Che() {
	...
	public static void init(String rootPath) {
		...
		try {
			...
			driverClass = props.getProperty("driverClass315che");
			jdbcUrl = props.getProperty("jdbcUrl315che");
			user = props.getProperty("user315che");
			password = props.getProperty("password315che");
			//proxoolDatasoucrce = props.getProperty("proxoolDatasoucrce");
